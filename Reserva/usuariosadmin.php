...
<div class="row">
	...
	<div class="span12">
		...
		<div style="text-align: center;"><h2> Viajeros registrados</h2>	</div>
		<hr class="soft"/>
		<div class="row-fluid">
		...
		<?php
				...
				echo "<table border='10'; class='btn btn-primary';>";
					echo "<tr class='warning'>";
						...
						echo "<td><font color='6D6D71' size='5'>User<br></font></td>";
						echo "<td><font color='000000' size='5'>Password<br></font></td>";
						echo "<td><font color='6D6D71' size='5'>Email<br></font></td>";
						echo "<td><font color='000000' size='5'>Passqdmin<br></font></td>";
						echo "<td><font color='6D6D71' size='5'>Rol<br></font></td>";
			...
			<?php 
				 while($arreglo=mysqli_fetch_array($query)){
				  	echo "<tr class='success'>";
				    	...
				    	echo "<td><font color='6D6D71'>$arreglo[5]</</td>";
